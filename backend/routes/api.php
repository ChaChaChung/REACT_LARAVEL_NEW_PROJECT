...
Route::prefix('fg')->group(function () {
    ...
    Route::get('/gameList', [FGController::class, 'gameList']); // 3.3 獲取遊戲列表
    Route::get('/appDownloadQRCode', [FGController::class, 'appDownloadQRCode']); // 3.4 APP 大廳下載二維碼
    ...
    Route::post('/logByCount', [FGController::class, 'logByCount']); // 4.5 根據時間獲取遊戲總的紀錄數 (時間範圍不能超過一天)
    ...
    Route::get('/jackpot', [FGController::class, 'jackpot']); // 4.12 獲取 JP 獎池
