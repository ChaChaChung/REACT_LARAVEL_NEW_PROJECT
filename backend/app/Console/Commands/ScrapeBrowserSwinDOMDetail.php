 ...
 * 瀏覽器 DOM 內容爬蟲命令
 */
class ScrapeBrowserSwinDOMDetail extends Command
{
    use HasAgentAuth;
     ...
     * @var string
     */
    protected $description = 'Scrape content from swin DOM elements using browser automation with detailed information';
    ...
    private function createPuppeteerScript($url, $date_start = null, $date_end = null, $account_number = null, $platform = null, $concurrency = 4)
    {
        ...
        $cookiesCodeForPage = $this->generateSwinPuppeteerCookiesCode('page');
